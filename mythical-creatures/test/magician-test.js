...
it('should be able to have clothing', function() {
...
it('pull rabbit from top hat', function() {
...
it('pull dove from sleeve', function() {
...
it('should start with with a confidence percentage of 10', function() {
    var magician = new Magician({ name: 'Leta' });

    assert.equal(magician.confidencePercentage, 10);
  });

it('should gain 10 confidence with each trick', function() {
    var magician = new Magician({ name: 'Leta' });
...
it('should be able to perform a showstopper with high enough condifence', function() {
...
it('should only be able to perform a showstopper with an assistant', function() {
